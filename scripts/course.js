// course.js — dynamic course cards, subject filter, and credit total
...
const courses = [
  ...
  },
  {
    ...
    certificate: "Web and Computer Programming",
    description:
      "This course builds on prior experience with Dynamic Web Fundamentals and programming. Students will focus on user experience, accessibility, compliance, performance optimization, and use of contemporary developer tools.",
    technology: ["HTML", "CSS", "JavaScript"],
    completed: false
  }
];
...
function displayCourses(list) {
  ...
  list.forEach((course) => {
    ...
    // Completed courses receive a distinct style
    if (course.completed) {
...
function showCredits(list) {
  // reduce() totals the credits of the courses currently displayed
...
filterButtons.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    displayCourses(filterCourses(button.dataset.subject));
  });
});
